...
#ifndef PXR_AR_DEFAULT_RESOLVER_CONTEXT_H
#define PXR_AR_DEFAULT_RESOLVER_CONTEXT_H

/// \file ar/defaultResolverContext.h

#include "./api.h"
#include "./defineResolverContext.h"
...
#endif // PXR_AR_DEFAULT_RESOLVER_CONTEXT_H
